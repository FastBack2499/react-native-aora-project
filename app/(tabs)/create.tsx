  ...
  return (
    <SafeAreaView className='bg-primary h-full'>
      <ScrollView className='px-4 my-6'>
        ...
        <FormField title='Video Title' value={form.title} placeholder='Give your Video a catchy title...' handleChangeText={(e) => {
          setForm({
            ...form,
            title: e
          })
        ...
        <View className='mt-7 gap-y-2'>
          ...
          <TouchableOpacity onPress={() => openPicker('video')}>
            {form.video ? (
              <Video source={{ uri: form.video.uri }} style={{ width: '100%', height: 256, borderRadius: 16 }} resizeMode={ResizeMode.COVER}/>
            ) : (
        ...
        <FormField title='AI Prompt' value={form.prompt} placeholder='The prompt you used to create this Video...' handleChangeText={(e) => {
          setForm({
            ...form,
            prompt: e
          })
