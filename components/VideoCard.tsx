...
const VideoCard = ({ video: { title, thumbnail, video, creator: { username, avatar }}} : any) => {
  ...
  return (
    <View className='flex-col items-center px-4 mb-14'>
      ...
      { play ? (
        <Video source={{ uri: video }} style={{ width: '100%', height: 240 }} className='w-full h-60 rounded-xl mt-3' resizeMode={ResizeMode.CONTAIN} useNativeControls shouldPlay onPlaybackStatusUpdate={(status: any) => {
